...
class CGScrollHelper
{
    ...
    public static function getArticle(&$id, $params)
    {
        ...
        if ($model) {
            ...
            $event_params = array('com_content.article', &$item_cls, &$item_cls->params, 0);
    ...
    public static function getLatest($id, $params)
    {
        ...
        $order_map = array(
            ...
            'mc_dsc' => 'CASE WHEN (a.modified = NULL) THEN a.created ELSE a.modified END',
            'c_dsc' => 'a.created',
            'p_dsc' => 'a.publish_up',
    ...
    public static function truncateString($string, $limit)
    {
        ...
        if (count($truncated_array) < count($string_array)) {
            $truncated_string .= '...<br/>';
        }
